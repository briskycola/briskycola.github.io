...
Arch Linux
```bash
sudo pacman -S qemu-desktop virt-manager virt-viewer dnsmasq vde2 openbsd-netcat libguestfs
```

Debian/Ubuntu
```bash
sudo apt install qemu-system virt-manager libvirt-daemon dnsmasq vde2 netcat-openbsd libguestfs-tools
```
